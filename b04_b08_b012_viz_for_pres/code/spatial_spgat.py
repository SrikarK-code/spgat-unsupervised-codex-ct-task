...
def train_and_eval(adata, Mu_tensor, device, num_parts=50, ce_weight=0.1, epochs=100):
    ...
    # MODIFICATION: Return the 'mapped' array so we can save it to CSV
...
if __name__ == "__main__":
    ...
    detailed_csv = "intestine_per_class_metrics.csv"
    ...
    spatial_preds_csv = "spgat_spatial_predictions.csv"
    ...
    for target in target_regions:
        ...
        # MODIFICATION: Save the best Unsupervised spatial predictions to CSV
