...
if __name__ == "__main__":
    ...
    # Set up the detailed per-class CSV
    ...
    for region in unique_regions:
        ...
        # Generate the classification report and save per-class metrics
        ...
        print(f"     [SUCCESS] Overall F1: {report_intra['weighted avg']['f1-score']:.4f}")
        ...
        for d in inter_donors:
            ...
            print(f"     [SUCCESS] Overall F1: {report_macro['weighted avg']['f1-score']:.4f}")
